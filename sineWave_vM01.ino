...
void setup() {
  for (int i = 0; i < 360; ++i) {
    if (491*sin(2*M_PI*i/360) - 8 < 16) {
      sineTableH[i] = 0;
    } else {
    sineTableH[i] = 491*sin(2*M_PI*i/360) - 8;
    }
    if (491*sin(2*M_PI*i/360) + 8 > 483) {
      sineTableL[i] = 500;
    } else if (491*sin(2*M_PI*i/360) < 16) {
      sineTableL[i] = 0;
    } else {
      sineTableL[i] = 491*sin(2*M_PI*i/360) + 8;
    }
  }
